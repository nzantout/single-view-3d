...
def fit_mesh(mesh_src: Meshes, mesh_tgt: Meshes, args):
    start_iter = 0
    ...
    rendering.render_mesh(mesh_src, 'images_out/q1_3_pred.gif', dist=1.5)
    rendering.render_mesh(mesh_tgt, 'images_out/q1_3_gt.gif', dist=1.5)
...
def fit_pointcloud(pointclouds_src, pointclouds_tgt, args):
    ...
    rendering.render_pointcloud(pointclouds_src, 'images_out/q1_2_pred.gif', dist=1.5)
    rendering.render_pointcloud(pointclouds_tgt, 'images_out/q1_2_gt.gif', dist=1.5)
...
def fit_voxel(voxels_src, voxels_tgt, args):
    ...
    voxels_src_image = rendering.render_voxels(voxels_src, 'images_out/q1_1_pred.gif')
    voxels_tgt_image = rendering.render_voxels(voxels_tgt, 'images_out/q1_1_gt.gif')
